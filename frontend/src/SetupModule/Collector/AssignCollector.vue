    ...
    <div class="mt-2 border-gray-200 pb-5 sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-3 sm:ml-4 sm:mt-0">
          ...
          <button type="button"
              ...
              <router-link :to="urlAssignCollector">Assign Collector</router-link>
...
<script>
    ...
    import ListTable from "@/SetupModule/Collector/ListTable";
    export default {
        ...
        data() {
            return {
                ...
                urlAssignCollector: "/assign-collector"
            }
        },
        mounted() {
